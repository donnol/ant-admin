      ...
      },
      {
        ...
        render: () => {
          ...
          if (this.state.data.cardId) {
            value =
              "[" + this.state.data.cardId + "]" + this.state.cardInfo.name;
          }
          let openModal = () => {
        ...
        render: value => {
          const columns = [
              ...
              render: () => {
                return (
                  <MySelect
                    ...
                    showSearch={true}
                    renderOption={(value, key) => "[" + key + "]" + value.name}
                  />
                );
              }
            },
            {
              ...
              render: () => {
                return (
                  <MyInputDecimal style={{ width: "100%" }} precision={2} />
                );
              }
            },
            {
            ...
            },
            {
              ...
              render: () => {
                return (
                  <MyInputDecimal style={{ width: "100%" }} disabled={true} />
                );
              }
            },
            {
              ...
              render: (val, data) => {
                return (
                  <a onClick={this.delItems.bind(this, data._key)}>删除</a>
                );
              }
            }
          ];
